/* 
 * 4.4a Program It (5.4c Revise It)
 * by Victor Lourng
...
public class Main {
    ...
    // Project 2.1:
      ...
      System.out.println("Here's my number, so call me maybe?");
      System.out.println("+1 (571)969-1778");
    ...
    // Project 2.2:
      ...
      System.out.println("A yield sign that encloses the word YIELD within a triangle.");
    ...
    // Project 2.3:
      ...
      System.out.print("How many kilometers do you want to convert into nautical miles?");
